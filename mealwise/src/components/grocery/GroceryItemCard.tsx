...
export const GroceryItemCard: React.FC<GroceryItemCardProps> = ({ item }) => {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -20 }}
      className={`bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 shadow-sm transition-all duration-200 ${
        item.isChecked ? 'opacity-60 line-through' : ''
      }`}
    >
